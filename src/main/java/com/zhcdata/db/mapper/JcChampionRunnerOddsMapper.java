...
public interface JcChampionRunnerOddsMapper extends Mapper<JcChampionRunnerOdds> {
    ...
    JcChampionRunnerOdds queryJcChampionRunnerOddsByPlayCodeAndMatchIdAndTeams(@Param("playCode")  String playCode, @Param("matchID") String matchID, @Param("teams") String teams);
}
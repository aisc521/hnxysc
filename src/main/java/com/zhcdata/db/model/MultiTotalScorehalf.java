...
public class MultiTotalScorehalf {
    ...
    public boolean oddsEquals(MultiTotalScorehalf mo) {
        return mo.getGoal().equals(goal) && mo.getUpodds().equals(upodds) && mo.getDownodds().equals(downodds);
    }
}
...
public class MultiLetgoal {
    ...
    public boolean nowOddsSame(MultiLetgoal db) {
        return db.goal.equals(goal)&&db.upodds.equals(upodds)&&db.downodds.equals(downodds)&&db.firstgoal.equals(firstgoal);
    }
}
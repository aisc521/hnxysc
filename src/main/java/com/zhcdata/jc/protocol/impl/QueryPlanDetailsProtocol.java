...
public class QueryPlanDetailsProtocol implements BaseProtocol {
    ...
    public Map<String, Object> processLogic(ProtocolParamDto.HeadBean headBean, Map<String, String> paramMap) throws Exception {
        ...
        try {
            ...
            List<Map<String, Object>> list = tbPlanService.queryPlanInfo(id, matchPlanType);
                ...
                for (int i = 0; i < list.size(); i++) {
                    ...
                    if (StringUtils.isNotBlank(odds) && odds != null && odds != "null") {
                        ...
                        if ("vs".equals(matchResult)) {
                            ...
                            } else if (oddsArr.length == 3) {
                                map.put("rang_sheng", "" + oddsArr[0]);  //胜
                                map.put("rang_ping", "" + oddsArr[2]);   //盘口
                                map.put("rang_fu", "" + oddsArr[1]);     //负
                            }
                        }
                    } else {
                        if ("vs".equals(matchResult)) {
                            ...
                            if (matchPlanType != null && matchPlanType.equals("2")) {
                                map.put("rang_sheng", "" + list.get(i).get("homeTeamZhu"));  //胜
                                map.put("rang_ping", "" + list.get(i).get("homeTeamPing"));   //盘口
                                map.put("rang_fu", "" + list.get(i).get("homeTeamKe"));     //负
                            } else {

        ...
        if(planIdDtoList!= null && planIdDtoList.size()>0){
            ...
            if(queryPlanByMatchIdDto != null && queryPlanByMatchIdDto.size() > 0){
                for(int j = 0; j < queryPlanByMatchIdDto.size(); j++){
                    ...
                    queryPlanByMatchIdDto1.setzFiveDays(String.valueOf(new BigDecimal(queryPlanByMatchIdDto1.getzFiveDays()).intValue()));
                    queryPlanByMatchIdDto1.setzThreeDays(String.valueOf(new BigDecimal(queryPlanByMatchIdDto1.getzThreeDays()).intValue()));

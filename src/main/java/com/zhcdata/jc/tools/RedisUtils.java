...
public class RedisUtils {
     ...
     * @return 成功个数
     */
    public long sAddList(String key, List list) {
        try {
            //使用pipeline方式
     ...
     * @return
     */
    public Object lrpop(String key, long time) {
        try {
     ...
     * @return
     */
    public boolean lleftPushIfPresent(String key, Object value) {
        try {

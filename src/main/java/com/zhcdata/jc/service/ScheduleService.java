...
public interface ScheduleService {
     ...
     * @return
     */
    List<MatchResult1> queryMacthListForJob( String startDate, String endDate, String s, String s1, String s2,String issueNum,List<String> panKouType,List<String> matchType,String isCheck);

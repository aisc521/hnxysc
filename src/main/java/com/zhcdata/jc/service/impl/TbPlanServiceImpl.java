...
public class TbPlanServiceImpl implements TbPlanService {
    ...
    @Override
    public int updateStatus(String isRight, String planHit, String id,String flag,Integer orderBy) {
        return tbJcPlanMapper.updateStatus(isRight,planHit,id,flag,orderBy);
    }
    ...
    @Override
    public PageInfo<PlanResult1> queryHotPlan(String type,String userId, Integer pageNo, int pageAmount) {
        PageHelper.startPage(pageNo, pageAmount);
        List<PlanResult1> list = tbJcPlanMapper.queryHotPlan(type,userId);
        return new PageInfo<>(list);
    }
    ...
    @Override
    public List<QueryPlanByMatchIdDto> queryPlanByPlanIdList(String[] planIdDtoList,String orderInfo) {
        return tbJcPlanMapper.queryPlanByPlanIdList(planIdDtoList,orderInfo);
    }

    @Override
    public List<QueryPlanByMatchIdDto> queryPlanInfoByPlanIdandUserIdList(String[] planIdDtoList, String userId,String orderInfo) {
        return tbJcPlanMapper.queryPlanInfoByPlanIdandUserIdList(planIdDtoList,userId,orderInfo);
    }
